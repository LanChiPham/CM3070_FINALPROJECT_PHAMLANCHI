...
ema = False # set to false as not using teacher 
data_dir = args['data'] 
...
# Create callbacks
test_file = np.random.choice(glob.glob('../data/Montgomery/images/*.png'))
...
'''
python3 train.py --data /Users/lanchipham/LungSegment/data/Montgomery --u-data /Users/lanchipham/LungSegment/data/Montgomery/images --momentum 0.999 --epochs 32  --batch-size 8 --u-batch-size 8 --val-ratio 0.2 --lr 0.0001 --save-path ../checkpoints --log-dir ../checkpoints 
'''